...
<input style="width:150px" name="dataevento" type="date" id="dataevento" value='date' >
<input style="width:150px" name="dataeventof" type="date" id="dataeventof" value='datef'>

<input type="submit"  value="Pesquisa Eventos"/>
...
$qry = mysqli_query($conn, "select * from usuarios_vip where chegada >= '{$data}' and chegada <= '{$dataf}' and  saida >= '{$data}'" );
...
$table = '<table border="1"><tr>';
	...
	$table .= '<th width="460px">'."nome".'</th>';
	$table .= '<th width="140px">'."Data de chegada".'</th>';
	$table .= '<th width="140px">'."Data de saida".'</th>';
	$table .= '<th width="300px">'."Tomador".'</th>';
	$table .= '<th width="100px">'."status".'</th>';
	$table .= '<th width="150px">'."cpf".'</th>';
	$table .= '<th width="20px">'."Visitantes".'</th>';
...
while($r = mysqli_fetch_assoc($qry)){
	$soma = $soma + $r['visitantes'];
	$table .= '<tr>';
	
	$table .= '<td>'.$r['nome'].'</td>';
	$table .= '<td>'.$r['chegada'].'</td>';
	$table .= '<td>'.$r['saida'].'</td>';
	$table .= '<td>'.$r['op'].'</td>';
	$table .= '<td>'.$r['status'].'</td>';
	$table .= '<td>'.$r['cpf'].'</td>';
	$table .= '<td>'.$r['visitantes'].'</td>';
